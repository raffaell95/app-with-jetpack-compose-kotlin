package com.raffa.movieapp.core.data.remote

import com.raffa.movieapp.core.data.remote.response.MovieDetailResponse
...
interface MovieService {
    ...
    @GET("search/multi")
    suspend fun searchMovie(@Query("page") page: Int,
