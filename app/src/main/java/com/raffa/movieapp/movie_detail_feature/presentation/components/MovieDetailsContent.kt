...
import com.raffa.movieapp.movie_detail_feature.data.mapper.toMovie
...
fun MovieDetailsContent(
    ...
    Column(
        ...
        MovieDetailBackdropImage(
            backdropImageUrl = movieDetails?.backgroundPathUrl.toString(),
            modifier = Modifier
                .fillMaxWidth()
                .height(200.dp)
        )
    ...
    MocieDetailSimilarMovies(
        pagingMoviesSimiler = pagingMovieSimilar,
        modifier = Modifier
            .fillMaxWidth()
            .fillMaxHeight(0.35f)
